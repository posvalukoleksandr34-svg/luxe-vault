      ...
      },
      {
        ...
        blocks: [
          ...
          { ul: [
            ...
            '**Telegram** — служебные уведомления сотрудникам магазина об оплаченных заказах; получает имя покупателя, email, телефон, адрес доставки и состав заказа.',
      ...
      },
      {
        ...
        blocks: [
          ...
          { ul: [
            ...
            '**Telegram** — internal notifications of paid orders to the shop\'s staff; receives the customer\'s name, email, phone number, delivery address and the contents of the order.',
      ...
      },
      {
        ...
        blocks: [
          ...
          { ul: [
            ...
            '**Telegram** — notifiche interne degli ordini pagati al personale del negozio; riceve nome, email, telefono e indirizzo di consegna del cliente e il contenuto dell\'ordine.',
