  ...
  return (
    <div className="not-prose mb-8 border-l-2 border-gold/50 bg-gold/[0.05] py-3 pl-4 pr-3">
      <p className="text-[12px] font-light leading-relaxed text-muted-foreground">
        ...
        Осталось заполнить: регистрационный номер компании, службу доставки и
        решение о представителе в ЕС по ст. 27 GDPR. Перед публикацией
        согласуйте текст с юристом, практикующим в Швейцарии.
      </p>
    </div>
  )
}
