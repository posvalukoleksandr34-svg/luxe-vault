  ...
  return (
    <>
      ...
      <div
        ...
        className="hide-with-keyboard animate-fade-up fixed inset-x-0 bottom-[calc(4rem+env(safe-area-inset-bottom))] z-[30] md:bottom-0 border-t border-gold/25 bg-popover/95 backdrop-blur-md"
      >
