...
export const UI = {
  ...
  "state.goToCatalog": { ru: "Перейти в каталог", en: "Go to catalog", it: "Vai al catalogo", fr: "Voir le catalogue", de: "Zum Katalog" },
  ...
  "stylist.restart": { ru: "Начать заново", en: "Start over", it: "Ricomincia", fr: "Recommencer", de: "Neu starten" },
