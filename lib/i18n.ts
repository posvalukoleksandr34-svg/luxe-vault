...
export const UI = {
  ...
  "header.currencyNote": { ru: "Оплата производится в CHF. Цены в других валютах — ориентировочные.", en: "Payment is in CHF. Prices in other currencies are indicative.", it: "Il pagamento avviene in CHF. I prezzi in altre valute sono indicativi.", fr: "Le paiement s'effectue en CHF. Les prix dans d'autres devises sont indicatifs.", de: "Die Zahlung erfolgt in CHF. Preise in anderen Währungen sind Richtwerte." },
  ...
  "checkout.chargedInChf": { ru: "Оплата списывается в швейцарских франках: {amount}. Суммы в {currency} — ориентировочные, по приблизительному курсу.", en: "You will be charged in Swiss francs: {amount}. Amounts in {currency} are indicative, at an approximate rate.", it: "L'addebito avviene in franchi svizzeri: {amount}. Gli importi in {currency} sono indicativi, a un tasso approssimativo.", fr: "Le débit est effectué en francs suisses : {amount}. Les montants en {currency} sont indicatifs, à un taux approximatif.", de: "Belastet wird in Schweizer Franken: {amount}. Beträge in {currency} sind Richtwerte zu einem ungefähren Kurs." },
  "cart.indicativeCurrency": { ru: "Цены в {currency} ориентировочные — оплата в CHF.", en: "Prices in {currency} are indicative — payment is in CHF.", it: "I prezzi in {currency} sono indicativi: il pagamento avviene in CHF.", fr: "Les prix en {currency} sont indicatifs : le paiement s'effectue en CHF.", de: "Preise in {currency} sind Richtwerte – bezahlt wird in CHF." },
