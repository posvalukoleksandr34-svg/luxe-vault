...
export const UI = {
  ...
  'wishlist.add': { ru: 'В избранное', en: 'Save to wishlist', it: 'Salva nei preferiti', fr: 'Ajouter aux favoris', de: 'Zur Merkliste' },
  'wishlist.remove': { ru: 'Убрать из избранного', en: 'Remove from wishlist', it: 'Rimuovi dai preferiti', fr: 'Retirer des favoris', de: 'Von der Merkliste entfernen' },
  ...
  'wishlist.failed': { ru: 'Не удалось обновить избранное', en: 'Could not update the wishlist', it: 'Impossibile aggiornare i preferiti', fr: 'Impossible de mettre à jour les favoris', de: 'Merkliste konnte nicht aktualisiert werden' },
