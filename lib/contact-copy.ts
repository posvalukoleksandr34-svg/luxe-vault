...
export const CONTACT_COPY: Record<Locale, ContactCopy> = {
  ru: {
    ...
    newsConsentAfter: '. Отказаться от рассылки можно в любой момент — просто напишите нам.',
  ...
  en: {
    ...
    newsConsentAfter: '. You can opt out at any time — just write to us.',
  ...
  it: {
    ...
    newsConsentAfter: '. Puoi annullare l’iscrizione in qualsiasi momento: basta scriverci.',
  ...
  fr: {
    ...
    newsConsentAfter: '. Vous pouvez vous désabonner à tout moment : écrivez-nous.',
  ...
  de: {
    ...
    newsConsentAfter: '. Sie können sich jederzeit abmelden – schreiben Sie uns einfach.',
