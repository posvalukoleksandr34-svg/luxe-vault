...
export const SUPPORT_COPY: Record<Locale, SupportCopy> = {
  en: {
    ...
    honest: 'This is not a live chat. A member of our team reads every message and replies within {span} — we email you as soon as we do.',
  ...
  ru: {
    ...
    honest: 'Это не онлайн-чат. Каждое сообщение читает сотрудник нашей команды и отвечает в течение {span} — мы сразу сообщим об ответе по email.',
  ...
  it: {
    ...
    honest: 'Non è una chat dal vivo. Una persona del nostro team legge ogni messaggio e risponde entro {span}: ti avvisiamo via email appena lo facciamo.',
  ...
  fr: {
    ...
    honest: 'Ce n’est pas un chat en direct. Un membre de notre équipe lit chaque message et répond sous {span} ; nous vous prévenons par e-mail dès que c’est fait.',
  ...
  de: {
    ...
    honest: 'Dies ist kein Live-Chat. Ein Mitglied unseres Teams liest jede Nachricht und antwortet innerhalb von {span} – wir benachrichtigen Sie per E-Mail, sobald wir geantwortet haben.',
